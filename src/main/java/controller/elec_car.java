...
public class elec_car {

	public String car_Data() {
		String address="http://apis.data.go.kr/B552584/EvCharger/getChargerInfo?serviceKey=uM73FRFMgpboVDCugtsdwWkNKzGf8E8tpuii9790h2dbDAKe8NqhrgPSQX59T3KQJXhu77drzOviMeDaSrnLxA%3D%3D&pageNo=1&numOfRows=10&zcode=11";
		String data="";
		try {
